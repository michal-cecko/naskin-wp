    ...
    build: {
        ...
        rollupOptions: {
            input: [
                ...
                'resources/scripts/components/admin/single-appointment.js',
                ...
                'resources/styles/admin/pages/calendar.scss',
                'resources/styles/admin/pages/appointment-single.scss',
