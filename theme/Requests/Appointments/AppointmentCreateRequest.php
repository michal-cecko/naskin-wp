...
namespace Saurus\App\Requests\Appointments;
...
class AppointmentCreateRequest extends Request {
    ...
    public function rules(): array {
        ...
        return [
            ...
            'services.*' => ['required_if:type,' . AppointmentType::RESERVATION->value, 'integer', new PostExists(postType: Service::getPostTypeSlug())],

            'customer' => ['required_if:type,' . AppointmentType::RESERVATION->value, 'array'],
            'customer.id' => ['sometimes', 'nullable', 'integer', new PostExists(postType: Customer::getPostTypeSlug())],
