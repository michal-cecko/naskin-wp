                                ...
                                <select v-model="appointment.serviceID" class="form-control" id="service">
                                    ...
                                    if ($services->have_posts()) : ?>
                                        <?php while ($services->have_posts()) : $services->the_post() ?>
                                            <option value="<?= get_the_ID() ?>" <?= $i === 0 ? "selected" : "" ?>><?= get_the_title() ?></option>
                                            <?php $i = 1; endwhile ?>
