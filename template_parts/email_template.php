...
<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0"
			...
			padding-bottom: 20px;">
                        ...
                        <!-- Set text color to background color -->
                            ...
                            <a target="_blank" style="text-decoration: none;"
                               href="<?= get_site_url() ?>"><!--<img border="0" vspace="0" hspace="0"
                                                                   src="<?= get_template_directory_uri() ?>/assets/images/Logo.png"
                                                                   width="160"
                                                                   alt="Logo" title="Logo" style="
				color: #000000;
				font-size: 10px; margin: 0; padding: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; border: none; display: block;"/>-->LOGO</a>
	...
	max-width: 560px;" class="container">
                ...
                <?php
                    ...
                    $serviceDuration = get_field("serv-duration", $service->ID);
                    $serviceTitle = get_the_title($service->ID);
                    $sendingToEmployee = $data['sendingToEmployee'] ?? false;
                    $id = $data['id'];

                    if($type === "new") {
                        if($sendingToEmployee) {
			...
			font-family: sans-serif;" class="subheader">
                ...
                $employee = get_user_by("ID", $data['employee']);
                ...
                if($type === "new") { ob_start(); ?>
                    ...
                    <?php else : ?>
                        ...
                        <b>Dátum a čas</b>: <?= $date->format("j.n.Y - H:i") ?><br>
                        <!-- TODO: DOPLNIT ADRESU -->
                        <b>Miesto</b>: Doplniť adresu pobočky...<br>
                        <b>Služba</b>: <?= $serviceTitle . " (" . $servicePrice. "€)" ?><br>
                        <b>Pracovník</b>: <?= $employee->first_name ?><br>
                    <?php endif ?>
			...
			font-family: sans-serif;" class="paragraph">
                ...
                <?php if (in_array($type, ['new', 'update', 'notification']) && !$sendingToEmployee) : ?>
                    ...
                    $cancelLink = false;
                    if(!empty($token)) {
                        $cancelLink = get_site_url() . "/wp-json/api/v1/cancel-reservation?t=$token&i=$id";
                    }
                    ?>
                    <?php if ($cancelLink) : ?>
			...
			padding-bottom: 5px;" class="button"><a
                    ...
                    <?php
                        ...
                        $icsLink = home_url() . "/wp-json/api/v1/generate-ics?s=" . $start . "&e=" . $end . "&n=NASKIN rezervácia - " . $serviceTitle . "&h=25egdWr459egFEe8";
                    ?>
			...
			padding-top: 25px;" class="line">
                    ...
                    <tr>
                        <td align="left" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-top: 10px; padding-right: 6.25%; width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%;
			padding-top: 25px;color: #000000;font-family: sans-serif;" class="paragraph">
                            Pridajte si termín do kalendára:
                        </td>
                    </tr>
			...
			padding-top: 25px;
			padding-bottom: 5px;" class="button"><a
                                    href="<?= $icsLink ?>" target="_blank" style="text-decoration: none;">
                                <table border="0" cellpadding="0" cellspacing="0" align="center"
                                       style="max-width: 240px; min-width: 120px; border-collapse: collapse; border-spacing: 0; padding: 0;">
                                    <tr>
                                        <td align="center" valign="middle"
			...
			color: #000000;
			font-family: sans-serif;" class="paragraph">
                        Máte nejaké otázky? <a href="mailto:info@naskin.sk" target="_blank"
                                        style="color: #127DB3; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 160%;">info@naskin.sk</a>
                    </td>
                </tr>
	...
	max-width: 560px;" class="wrapper">
			...
			padding-top: 25px;" class="social-icons">
                ...
                <!-- Set text color and font family ("sans-serif" or "Georgia, serif"). Duplicate all text styles in links, including line-height -->
                <tr>
<!--  TODO: CHANGE LATER WEB URL                   -->
                    <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 13px; font-weight: 400; line-height: 150%;
			padding-top: 20px;
			padding-bottom: 20px;
			color: #999999;
			font-family: sans-serif;" class="footer">
                        Tento email Vám bol odoslaný z webu <a href="<?= get_site_url() ?>" target="_blank"
                                                               style="text-decoration: underline; color: #999999; font-family: sans-serif; font-size: 13px; font-weight: 400; line-height: 150%;">www.naskin.sk</a>.
                    </td>
                </tr>
