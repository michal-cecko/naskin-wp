...
function admin_enqueue_scripts()
{
    ...
    if( in_array('employee', $user->roles) || in_array('together-employee', $user->roles) ){
        wp_enqueue_style('employees-css', get_template_directory_uri() . '/dist/css/admin/employee_role.css', FALSE, time());
    }

    wp_register_script("admin-js", get_template_directory_uri() . '/dist/js/admin.js', false, time(), TRUE);
